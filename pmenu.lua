...
local _intX, _intY = .25, .175
local _intW, _intH = .240, .033
local spriteW, spriteH = .240, .0600
local PMenu = {}
local parentSliderSize = .24
...
function PMenu:DrawHeader(intCount)
	...
	self.Height = self.Height + 0.005
	DrawText2(0, stringCounter, .275, self.Width - rectW / 2 + .9, self.Height - _intH, color_white, true, 2)
